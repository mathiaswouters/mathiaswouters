export const logos = {
  onLightBg: "/mw-logo-dark-no_bg.svg",
  onDarkBg: "/mw-logo-light-no_bg.svg",
  faviconLight: "/mw-logo-dark.svg",
  faviconDark: "/mw-logo-light.svg",
} as const

export const siteConfig = {
  name: "Mathias Wouters",
  title: "Mathias Wouters — Cloud, DevOps & Linux Consultant",
  description:
